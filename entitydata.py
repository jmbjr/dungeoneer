...
mobs={}
mobs = {
 'johnstein':      {'char':'j', 'color':libtcod.white,       'tilechar':data.TILE_SKEL_WHITE,   'fighter':{'hp':10 , 'defense':0 , 'power':2 , 'xp':20 , 'clan':'monster', 'death_function': entities.monster_death, 'speed':1}, 'caster':{'mp':10}}, 
